...
namespace SchedulingClients.JobBuilderServiceReference {
    ...
    public interface IJobBuilderService {
        ...
        System.Tuple<GACore.SemVerData, SchedulingClients.JobBuilderServiceReference.ServiceCallData> GetSemVer();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetSemVer", ReplyAction="http://tempuri.org/IService/GetSemVerResponse")]
        System.Threading.Tasks.Task<System.Tuple<GACore.SemVerData, SchedulingClients.JobBuilderServiceReference.ServiceCallData>> GetSemVerAsync();
        ...
        System.Tuple<int, SchedulingClients.JobBuilderServiceReference.ServiceCallData> CreateServicingTask(int parentTaskId, int nodeId, GACore.Architecture.ServiceType serviceType, System.TimeSpan expectedDuration);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IJobBuilderService/CreateServicingTask", ReplyAction="http://tempuri.org/IJobBuilderService/CreateServicingTaskResponse")]
        System.Threading.Tasks.Task<System.Tuple<int, SchedulingClients.JobBuilderServiceReference.ServiceCallData>> CreateServicingTaskAsync(int parentTaskId, int nodeId, GACore.Architecture.ServiceType serviceType, System.TimeSpan expectedDuration);
    ...
    public partial class JobBuilderServiceClient : System.ServiceModel.ClientBase<SchedulingClients.JobBuilderServiceReference.IJobBuilderService>, SchedulingClients.JobBuilderServiceReference.IJobBuilderService {
        ...
        public System.Tuple<GACore.SemVerData, SchedulingClients.JobBuilderServiceReference.ServiceCallData> GetSemVer() {
            return base.Channel.GetSemVer();
        }
        
        public System.Threading.Tasks.Task<System.Tuple<GACore.SemVerData, SchedulingClients.JobBuilderServiceReference.ServiceCallData>> GetSemVerAsync() {
        ...
        public System.Tuple<int, SchedulingClients.JobBuilderServiceReference.ServiceCallData> CreateServicingTask(int parentTaskId, int nodeId, GACore.Architecture.ServiceType serviceType, System.TimeSpan expectedDuration) {
            return base.Channel.CreateServicingTask(parentTaskId, nodeId, serviceType, expectedDuration);
        }
        
        public System.Threading.Tasks.Task<System.Tuple<int, SchedulingClients.JobBuilderServiceReference.ServiceCallData>> CreateServicingTaskAsync(int parentTaskId, int nodeId, GACore.Architecture.ServiceType serviceType, System.TimeSpan expectedDuration) {
